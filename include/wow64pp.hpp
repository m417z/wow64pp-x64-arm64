...
inline static std::uint64_t wow64_system_service_ex_original =
    0xD4200000D4200000;
#pragma code_seg(pop, r1)

#pragma code_seg(push, r1, ".text64$b")
__declspec(allocate(".text64$b"))  //
inline static std::uint8_t wow64_system_service_ex_hook[] = {
    // clang-format off
...
CALL_FUNCTION_ARM64_DATA* get_call_function_arm64_data() {
    WOW64PP_STATIC_INIT_ONCE_TRIVIAL(
        ...
        ([]() -> CALL_FUNCTION_ARM64_DATA {
            ...
            DWORD dwOldProtect;
            VirtualProtect(&wow64_system_service_ex_original,
                           sizeof(wow64_system_service_ex_original),
                           PAGE_READWRITE, &dwOldProtect);
            wow64_system_service_ex_original =
...
inline std::uint64_t call_function_arm64(std::error_code& ec,
    ...
    if (data->call_count == 0) {
        ...
        VirtualProtect(pp_wow64_system_service_ex,
                       ...
                       &dwOldProtect);
        *pp_wow64_system_service_ex =
            reinterpret_cast<std::uint64_t>(wow64_system_service_ex_hook);
        VirtualProtect(pp_wow64_system_service_ex,
